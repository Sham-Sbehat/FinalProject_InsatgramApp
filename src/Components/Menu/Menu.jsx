...
const drawer = (
    ...
    >
      <Fade in={openM}>
        <Box sx={{height:513,width:572,margin:'auto',backgroundColor:'gray'}}> 
         <h2 style={{textAlign:"center",color:'white'}}>Create new post</h2>
        ...
        />
                ...
                <Button component="label" variant="contained" startIcon={<CloudUploadIcon />} style={{marginTop:"-50px",marginLeft:'10px'}} >
                Choose Image  <VisuallyHiddenInput type="file" /></Button>
                <Button variant="contained" endIcon={<SendIcon />} style={{marginTop:"100px", marginLeft:"100"}}>Post</Button>
        </Box>
      </Fade>
    </Modal> */}
